...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.statusResultsLabel = QLabel(self.OptionsView)
        self.statusResultsLabel.setObjectName(u"statusResultsLabel")
        self.statusResultsLabel.setGeometry(QRect(9, 632, 16, 16))
        font3 = QFont()
        font3.setPointSize(10)
        self.statusResultsLabel.setFont(font3)
        self.layoutWidget = QWidget(self.OptionsView)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(10, 10, 1282, 510))
        ...
        self.prestateLabel = QLabel(self.layoutWidget)
        self.prestateLabel.setObjectName(u"prestateLabel")
        font4 = QFont()
        font4.setPointSize(18)
        font4.setBold(True)
        self.prestateLabel.setFont(font4)
        ...
        self.reglabel = QLabel(self.layoutWidget)
        ...
        self.reglabel.setFont(font3)

        self.regOption.addWidget(self.reglabel)

        self.regedit = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_2 = QLabel(self.layoutWidget)
        ...
        self.reglabel_2.setFont(font3)

        self.regOption_2.addWidget(self.reglabel_2)

        self.regedit_2 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_3 = QLabel(self.layoutWidget)
        ...
        self.reglabel_3.setFont(font3)

        self.regOption_3.addWidget(self.reglabel_3)

        self.regedit_3 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_4 = QLabel(self.layoutWidget)
        ...
        self.reglabel_4.setFont(font3)

        self.regOption_4.addWidget(self.reglabel_4)

        self.regedit_4 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_5 = QLabel(self.layoutWidget)
        ...
        self.reglabel_5.setFont(font3)

        self.regOption_5.addWidget(self.reglabel_5)

        self.regedit_5 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_6 = QLabel(self.layoutWidget)
        ...
        self.reglabel_6.setFont(font3)

        self.regOption_6.addWidget(self.reglabel_6)

        self.regedit_6 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_7 = QLabel(self.layoutWidget)
        ...
        self.reglabel_7.setFont(font3)

        self.regOption_7.addWidget(self.reglabel_7)

        self.regedit_7 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_8 = QLabel(self.layoutWidget)
        ...
        self.reglabel_8.setFont(font3)

        self.regOption_8.addWidget(self.reglabel_8)

        self.regedit_8 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_9 = QLabel(self.layoutWidget)
        ...
        self.reglabel_9.setFont(font3)

        self.regOption_9.addWidget(self.reglabel_9)

        self.regedit_9 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_10 = QLabel(self.layoutWidget)
        ...
        self.reglabel_10.setFont(font3)

        self.regOption_10.addWidget(self.reglabel_10)

        self.regedit_10 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_11 = QLabel(self.layoutWidget)
        ...
        self.reglabel_11.setFont(font3)

        self.regOption_11.addWidget(self.reglabel_11)

        self.regedit_11 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_12 = QLabel(self.layoutWidget)
        ...
        self.reglabel_12.setFont(font3)

        self.regOption_12.addWidget(self.reglabel_12)

        self.regedit_12 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_13 = QLabel(self.layoutWidget)
        ...
        self.reglabel_13.setFont(font3)

        self.regOption_13.addWidget(self.reglabel_13)

        self.regedit_13 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_14 = QLabel(self.layoutWidget)
        ...
        self.reglabel_14.setFont(font3)

        self.regOption_14.addWidget(self.reglabel_14)

        self.regedit_14 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_15 = QLabel(self.layoutWidget)
        ...
        self.reglabel_15.setFont(font3)

        self.regOption_15.addWidget(self.reglabel_15)

        self.regedit_15 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_16 = QLabel(self.layoutWidget)
        ...
        self.reglabel_16.setFont(font3)

        self.regOption_16.addWidget(self.reglabel_16)

        self.regedit_16 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_17 = QLabel(self.layoutWidget)
        ...
        self.reglabel_17.setFont(font3)

        self.regOption_17.addWidget(self.reglabel_17)

        self.regedit_17 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_18 = QLabel(self.layoutWidget)
        ...
        self.reglabel_18.setFont(font3)

        self.regOption_18.addWidget(self.reglabel_18)

        self.regedit_18 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_19 = QLabel(self.layoutWidget)
        ...
        self.reglabel_19.setFont(font3)

        self.regOption_19.addWidget(self.reglabel_19)

        self.regedit_19 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_20 = QLabel(self.layoutWidget)
        ...
        self.reglabel_20.setFont(font3)

        self.regOption_20.addWidget(self.reglabel_20)

        self.regedit_20 = QLineEdit(self.layoutWidget)
        ...
        self.reglabel_21 = QLabel(self.layoutWidget)
        ...
        self.reglabel_21.setFont(font3)

        self.regOption_21.addWidget(self.reglabel_21)

        self.regedit_21 = QLineEdit(self.layoutWidget)
        ...
        self.searchLabel = QLabel(self.layoutWidget)
        ...
        self.badBytesEdit = QLineEdit(self.layoutWidget)
        ...
        self.depthBox = QSpinBox(self.layoutWidget)
        ...
        self.blockEdit = QLineEdit(self.layoutWidget)
        ...
        self.clearCacheButton = QPushButton(self.layoutWidget)
    ...
    def retranslateUi(self, Form):
        ...
        self.statusResultsLabel.setText("")
