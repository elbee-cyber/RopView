...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayout_7 = QVBoxLayout(self.OptionsView)
        ...
        self.verticalLayout_6.addLayout(self.prestateOptions)
        ...
        self.searchOptions = QVBoxLayout()
        self.searchOptions.setObjectName(u"searchOptions")
        ...
        self.searchOptions.addWidget(self.searchLabel)
        ...
        self.qualityOpt = QHBoxLayout()
        self.qualityOpt.setObjectName(u"qualityOpt")
        self.label_4 = QLabel(self.OptionsView)
        self.label_4.setObjectName(u"label_4")

        self.qualityOpt.addWidget(self.label_4)

        self.qualitySpinBox = QSpinBox(self.OptionsView)
        self.qualitySpinBox.setObjectName(u"qualitySpinBox")

        self.qualityOpt.addWidget(self.qualitySpinBox)


        self.options1.addLayout(self.qualityOpt)


        self.searchOptions.addLayout(self.options1)
        ...
        self.statusResultsLabel.setFont(font4)

        self.verticalLayout_7.addWidget(self.statusResultsLabel)
...
#if QT_CONFIG(tooltip)
        self.label_4.setToolTip(QCoreApplication.translate("Form", u"Gadget quality.", None))
#endif // QT_CONFIG(tooltip)
        self.label_4.setText(QCoreApplication.translate("Form", u"Quality:", None))
#if QT_CONFIG(tooltip)
        self.qualitySpinBox.setToolTip(QCoreApplication.translate("Form", u"Gadget quality", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
